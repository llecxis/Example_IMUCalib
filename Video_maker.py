...
class video_player():
    ...
    def __init__(self, filename=None, ports=['5569', '5571', '5563', '5561', '5559']):
        ...
        if filename== None:
            ...
            filename = os.path.join(local_path, 'example_data/')
        ...
        # print(len(list_delts),len(old_times))
...
if __name__ == "__main__":
    vp = video_player('C:/Users/User/GoogleДиск/Аспирантура/MIMU_project/example_data')
    # local_path = os.getcwd()
    # for name in vp.qtrs:
    #     i = 472
